...
public class RecordController {
    ...
    public void recordMenu() {
        while (true) {
            ...
            System.out.println("         1.기록하기 2.기록 삭제\n" +
                    "3.나의 기록 조회 4.팔로우한 사람의 기록 조회 0.뒤로가기");
    ...
    public void createRecord() {
        ...
        System.out.print("달린 시간 입력(시간,분,초) x입력시 기록취소");
        try {
            while (true) {
                System.out.print("(시간) : ");
        ...
        System.out.println("예상된 소모한 칼로리 : " + calorie + "(kcal)");
    ...
    private void showFollowingUserRecord() {
        ...
        while (true){
            System.out.print("조회하고싶은 회원의 ID번호입력 (0입력시 뒤로가기) : " );
            int id =
        }
    }
}
